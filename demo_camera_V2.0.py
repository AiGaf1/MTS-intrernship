...
if __name__ == '__main__':
    ...
    w, h = model_wh('0x0')
    if w > 0 and h > 0:
        e = TfPoseEstimator('/home/aigaf/pose-estimation-detection/models/graph/mobilenet_thin/graph_opt.pb', target_size=(w, h))
    else:
        e = TfPoseEstimator('/home/aigaf/pose-estimation-detection/models/graph/mobilenet_thin/graph_opt.pb', target_size=(432, 368))
